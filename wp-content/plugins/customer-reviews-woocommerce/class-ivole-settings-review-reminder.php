...
class Ivole_Review_Reminder_Settings {
    ...
    public function save() {
        ...
        if( ! empty( $_POST ) && isset( $_POST['ivole_form_geolocation'] ) ) {
    ...
    protected function init_settings() {
        ...
        $this->settings = array(
            array(
                ...
                'type'  => 'title',
                'desc'  => __( 'Configure the plugin to use <a href="https://www.cusrev.com" target="_blank" rel="noopener noreferrer">CR (Customer Reviews)</a> service for sending automatic follow-up emails (reminders) that gather shop and product reviews. Review reminders are sent via an independent service because people commonly consider reviews managed by shops themselves to be biased or fake. Independent collection of customer feedback also enables other optional features such as trust badges or verification of reviews.<br><br>Before enabling this feature you MUST update your terms and conditions and make sure that your customers consent to receive an invitation to review their order. By enabling and using this service, you agree to the <a href="https://www.cusrev.com/terms.html" target="_blank">terms and conditions</a>.', IVOLE_TEXT_DOMAIN ),
                'id'    => 'ivole_options'
            ),
            array(
            ...
            array(
                ...
                'type'  => 'title',
                'desc'  => __( 'Adjust template of the aggregated review forms that will be created and sent to customers by CR. Modifications will be applied to the next review form created after saving settings.', IVOLE_TEXT_DOMAIN ),
