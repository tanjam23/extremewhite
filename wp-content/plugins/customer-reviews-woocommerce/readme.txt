...
The plugin works as an interface to an external service for verification of customer reviews. The service called CR (Customer Reviews) facilitates collection of reviews from customers (including people who never bother to write reviews) and increases impact of reviews on purchasing decisions by verifying their authenticity. Information about terms, privacy, and data protection policies of CR is provided on [CR website](https://www.cusrev.com).
