...
d=document.getElementById("testFtpDialogBodyFail"),e=document.getElementById("testFtpDialogLabel");b.style.display="none";d.style.display="none";!0===a?(e.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK,b.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK,b.style.display="block",d.style.display="none"):(e.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL,d.textContent=a,b.style.display="none",d.style.display=
...
b["default"]==h&&m.setAttribute("selected","selected");l.appendChild(m)}akeeba.System.addEventListener(l,"change",function(a){a={};var b=[document.getElementById(g+"_config").querySelectorAll("input"),document.getElementById(g+"_config").querySelectorAll("select")],d=null,c=null,e=null;for(i=0;i<b.length;i++)if(d=b[i],d.length)for(j=0;j<d.length;j++)c=d[j],e=c.id,a[e]=c.value,"checkbox"==c.getAttribute("type")?a[e]=c.checked:"select"==c.getAttribute("type")&&(a[e]=c.options[c.selectedIndex].value);
var h=akeeba.Configuration.engines[f][l.value],b={};b[h.information.title]=h.parameters;akeeba.Configuration.parseGuiData(b,k);b=k.querySelector("header");b instanceof Element&&b.insertAdjacentHTML("afterend",'<p class="akeeba-block--information">'+h.information.description+"</p>");b=[document.getElementById(g+"_config").querySelectorAll("input"),document.getElementById(g+"_config").querySelectorAll("select")];for(i=0;i<b.length;i++)if(d=b[i],d.length)for(j=0;j<d.length;j++)c=d[j],e=c.id,e=a[e],null==
e||void 0==e||("checkbox"==c.getAttribute("type")?e?c.setAttribute("checked","checked"):c.removeAttribute("checked"):c.value=e,1==i&&akeeba.System.triggerEvent(c,"change"));if("undefined"!==typeof h.information.activation_callback)window[h.information.activation_callback](h.parameters)});h=document.createElement("button");h.className="akeeba-btn--small--dark";a=document.createElement("span");a.className="akion-wrench";h.appendChild(a);a=document.createElement("span");a.innerHTML=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_UI_CONFIG;
...
"click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;a=b.hook;try{eval(a+"()")}catch(c){}});f=document.createElement("span");f.className="input-append";f.appendChild(c);f.appendChild(a);d.appendChild(f);e.appendChild(d)};
...
akconfig_onedrivebusiness_oauth_callback=function(a){document.getElementById("var[engine.postproc.onedrive.service_id]").value=a.service_id;document.getElementById("var[engine.postproc.onedrive.refresh_token]").value=a.refresh_token;myWindow=window.open("","akeeba_onedrivebusiness_window");myWindow.close()};akconfig_googledrive_openoauth=function(){var a=akeeba.Configuration.URLs.dpeauthopen,a=-1==a.indexOf("?")?a+"?":a+"&";window.open(a+"engine=googledrive","akeeba_googledrive_window","width=1010,height=500")};
