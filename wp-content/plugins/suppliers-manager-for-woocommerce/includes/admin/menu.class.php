...
if (!class_exists('FT_SMFW_menu')) {
    class FT_SMFW_menu
    {
        ...
        public function adjust_the_wp_menu()
        {
            ...
            add_submenu_page(
                FT_SMFW_POST_TYPE . '_suppliers',
                __('Settings', FT_SMFW_TEXT_DOMAIN),
                __('Settings', FT_SMFW_TEXT_DOMAIN),
                'manage_options',
                FT_SMFW_POST_TYPE . '_settings',
                array(FT_SMFW_settings::class, 'settings_page_callback')
            );
            ...
            <div class="wrap tf_smfw tf_smfw_go_pro">
                <div class="no-supplier-card">
                    <div class="content">
                        ...
                        <p><?php _e("Your suppliers list is empty. To use perfectly this plugin, start by adding your first supplier by clicking on the button bellow.", FT_SMFW_TEXT_DOMAIN); ?></p>
