...
if (!class_exists('FT_SMFW_wc_products')) {
    class FT_SMFW_wc_products
    {
        ...
        public function register_columns($columns)
        {
            ...
            $columns[FT_SMFW_POST_TYPE . '_supplier_part_number'] = __("Part number", FT_SMFW_TEXT_DOMAIN);
        ...
        public function populate_columns($column, $post_id)
        {
            switch ($column) :
                ...
                case FT_SMFW_POST_TYPE . '_supplier_packaging':
                    ...
                    break;
                case FT_SMFW_POST_TYPE . '_supplier_part_number':
                    if ($part_number = get_post_meta($post_id , 'ft_smfw_supplier_part_number' , true)) {
                        _e($part_number);
                    } else {
                        _e("–", FT_SMFW_TEXT_DOMAIN);
                    }
