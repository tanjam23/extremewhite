 ...
 * @access public
 */
final class rich_store_lite_Example_1_Customize {
	...
	public function rich_store_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'rich_store_lite_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new rich_store_lite_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Upgrade to Pro', 'rich-store-lite' ),
					'pro_text' => esc_html__( 'Upgrade Now', 'rich-store-lite' ),
					'pro_url'  => rich_store_lite_PROTHEME_URL,
					'priority'   => 1,
				)
			)
		);
...
rich_store_lite_Example_1_Customize::rich_store_lite_get_instance();